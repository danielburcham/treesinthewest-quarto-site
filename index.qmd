...
::: {layout="[0.2, 0.32]"}
[![](images/plantSelectLogo.png){.logo-mobile fig-alt="Plant Select logo" fig-align="center"}](https://plantselect.org){target=blank}

[![](images/planitGeoLogo.png){.logo-mobile fig-alt="PlanIT Geo logo" fig-align="center"}](https://www.planitgeo.com){target=blank}
:::

For information about sponsorship opportunities, please contact [Jonathan Martin](mailto:jonathan.martin@colostate.edu).
